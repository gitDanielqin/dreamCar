...
var appMain = new Vue({
    ...
    methods: {
        ...
        publish: function publish(type) {
            ...
            //检测联系方式地址信息
            var linkAddress = (0, _jquery2.default)("input.dis-Addr:visible");
            ...
            if (type == "combi") {
                ...
                if ((0, _jquery2.default)(".cont-combi .sel-pos-1 input").val() == "不限") {
                    //岗位信息不能为不限
                    (0, _jquery2.default)(".sel-position:visible input").addClass("hint-nullable");
                    isValid = false;
                } else {
                    (0, _jquery2.default)(".sel-position:visible input").removeClass("hint-nullable");
                }

                if (this.combiData.incApply.posAmount == "不限") {
                    (0, _jquery2.default)(".pos-item input").addClass("hint-nullable");
                    isValid = false;
                } else {
                    (0, _jquery2.default)(".pos-item input").removeClass("hint-nullable");
                }
                ...
                if ((0, _jquery2.default)(".cont-recruit .major-input-1 input").val() == "不限") {
                    (0, _jquery2.default)(".cont-recruit .major-input input").addClass("hint-nullable");
                    isValid = false;
                } else {
                    (0, _jquery2.default)(".cont-recruit .major-input input").removeClass("hint-nullable");
                }
                if (this.recruitData.stuScale == "不限") {
                    (0, _jquery2.default)(".cont-recruit .pro-count input").addClass("hint-nullable");
                    isValid = false;
                } else {
                    (0, _jquery2.default)(".cont-recruit .pro-count input").removeClass("hint-nullable");
                }
                if (!isValid) {
                    swal({
                        title: "",
