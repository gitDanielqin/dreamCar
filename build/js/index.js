webpackJsonp([5], {
            ...
            ! function() {
                ...
                var e,
                    a = function a(t, s) {
                        ...
                        var h = {};
                        for (var v in s) {
                            if ("object" != _typeof(s[v]) || null === s[v] || s[v].nodeType || s[v] === window || s[v] === document || "undefined" != typeof Dom7 && s[v] instanceof Dom7 || "undefined" != typeof jQuery && s[v] instanceof jQuery) h[v] = s[v];
                            else {
                                h[v] = {};
                                for (var f in s[v]) {
                                    h[v][f] = s[v][f];
                        ...
                        for (var w in c) {
                            ...
                            else if ("object" == _typeof(s[w]))
                                for (var y in c[w]) {
                                    void 0 === s[w][y] && (s[w][y] = c[w][y]);
                                }
                        }
                        var x = this;
                        if (x.params = s, x.originalParams = h, x.classNames = [], void 0 !== e && "undefined" != typeof Dom7 && (e = Dom7), (void 0 !== e || (e = "undefined" == typeof Dom7 ? window.Dom7 || window.Zepto || __webpack_provided_window_dot_jQuery : Dom7)) && (x.$ = e, x.currentBreakpoint = void 0, x.getActiveBreakpoint = function() {
                            ...
                            x.onTouchStart = function(a) {
                                ...
                                if (x.params.loop && x.destroyLoop(), "object" == (typeof e === "undefined" ? "undefined" : _typeof(e)) && e.length)
                ...
                var r;
                r = "undefined" == typeof Dom7 ? window.Dom7 || window.Zepto || __webpack_provided_window_dot_jQuery : Dom7, r && ("transitionEnd" in r.fn || (r.fn.transitionEnd = function(e) {
                    function a(i) {
                        if (i.target === this)
    ...
    /***/
        ...
        function init_pos() {
            ...
            //六大板块入口的位置
            var entryMatop = (winH * 0.35 - (0, _jquery2.default)(".module-entry li").width()) / 2;
            (0, _jquery2.default)(".module-entry").css({
                "margin-top": Math.floor(entryMatop) + "px",
                "margin-bottom": Math.floor(entryMatop) + "px"
            });
            //中间部分的位置
            var centerMatop = (winH - (0, _jquery2.default)(".header").outerHeight(true) - (0, _jquery2.default)(".center-teil").outerHeight(true) - (0, _jquery2.default)(".module-entry").outerHeight(true)) / 2;
            ...
            //     //关于我们图标的显示
            // );
            (0, _jquery2.default)(".about-lis").css("top", Math.floor(winH * 0.5));
            (0, _jquery2.default)(".about-lis").css("left", Math.floor(winW * 0.5 - (0, _jquery2.default)(".inner").width() * 0.5));
        }
        //init_pos();
        ...
        var appFront = new Vue({
            ...
            methods: {
                ...
                clickFront: function clickFront(obj) {
                    if (!(0, _jquery2.default)(obj).hasClass("search-nav") && !(0, _jquery2.default)(obj).hasClass("search-nav")) {
                        (0, _jquery2.default)("#search-options").css("opacity", 0);
                    }
                },
                showSeachOptions: function showSeachOptions() {
                    (0, _jquery2.default)("#search-options").css("opacity", 1);
                },
                selectSearchLabel: function selectSearchLabel(obj) {
                    if (!(0, _jquery2.default)(obj).hasClass("search-nav")) {
                        (0, _jquery2.default)(".search-nav .on").removeClass("on");
                ...
                search: function search() {
                    ...
                    var searchObj = (0, _jquery2.default)(".search-nav .on");
                ...
                downwards: function downwards() {
                    (0, _jquery2.default)("html,body").animate({ //HTML兼容FF , body 兼容 Chrome
        ...
        var appShow = new Vue({
            el: "#app-show",
            data: {
                showInfos: [{ imgsrc: "images/case1.jpg", txt: "解决大学生从学习到就业的信息" }, { imgsrc: "images/case2.jpg", txt: "解决大学生从学习到就业的信息" }, { imgsrc: "images/case3.jpg", txt: "解决大学生从学习到就业的信息" }, { imgsrc: "images/case4.jpg", txt: "解决大学生从学习到就业的信息" }, { imgsrc: "images/case5.jpg", txt: "解决大学生从学习到就业的信息" }]
            },
            methods: {
        ...
        var appCoop = new Vue({
            el: "#app-coop",
            data: {
                coopInc: [{ imgsrc: "images/logo-vipabc.jpg" }, { imgsrc: "images/logo-unicom.jpg" }, { imgsrc: "images/logo-hikvision.jpg" }, { imgsrc: "images/logo-ishangzu.jpg" }, { imgsrc: "images/logo-tonghua.jpg" }, { imgsrc: "images/logo-hundsn.jpg" }, { imgsrc: "images/logo-telecom.jpg" }, { imgsrc: "images/logo-tax.png" }, { imgsrc: "images/logo-chinamobile.png" }, { imgsrc: "images/logo-pandora.jpg" }],
            ...
            mounted: function mounted() {
                (0, _jquery2.default)("#app-coop").height(EventUtils.getViewport().height - (0, _jquery2.default)("#app-footer").outerHeight(true));
            }
        });
