(function() {
    var mobileTempl = '<div class="bind-change mobile-bind" @click.stop="">\
        ...
        <div class="bind-form">\
            ...
            <p><input type="text" placeholder="完成手机号" v-model="mobile" class="input-mobile"></p>\
            ...
            <p><input type="password" placeholder="确认登入密码" v-model="password" class="input-password"></p>\
